...
<body style="background-color: #e6e6e6;">
    ...
    <div class="page-content  text-center">
	    <div class="container">
            <h1>Contributor Accounts in the system</h1>		
			<section class="card">							
				<div class="card-block">
					<table id="table" class="table table-bordered" style="background:#fff;">					
						...
						<tbody>						
							...
							$user = $_SESSION['user'];
							//echo $user;							
							$query = "SELECT * from usertbl where strRole='contributor' order by strDate DESC ";
							$result = executeSelectQuery($query);
							if ($result->num_rows > 0){
								while($req_row = $result->fetch_assoc()) {		
							?>
							<tr>
								<td><a href="deleteAccount.php?v=3&id=<?php echo $req_row['strUsername']; ?>"><span class="label label-danger">Delete</span></a></td>
