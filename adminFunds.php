...
<body style="background-color: #e6e6e6;">
	...
	<div class="page-content  text-center">
		<div class="container">
			<h1>Available Funds in the system</h1>
			<section class="card">						
					...
					<table id="table" class="table table-bordered" style="background:#fff;">					
						...
						<tbody>						
							...
							<tr>
								...
								<?php
									$id = $req_row['intSpecies'];
									$query1 = "SELECT count(*) as count from contribution where intSpecies = '$id' and status='1'";												
									$result1 = executeSelectQuery($query1);
									$req_row1 = $result1->fetch_assoc();
								?>				
								<td><?php echo $req_row1['count']; ?></td>
								<td><?php echo " $ ".$req_row1['count']*$req_row['intCost']; ?></td> 					   
							</tr>										
							<?php							
								}  }
							?>						
