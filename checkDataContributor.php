...
<?php
	...
	if(isset($_POST['user_name']))
	{
		...
		$checkdata=" SELECT * FROM usertbl WHERE strUsername = '$name' AND role = 2";
		//print_r($checkdata);
	...
	if(isset($_POST['user_email']))
	{
		...
		$checkdata=" SELECT * FROM usertbl WHERE strEmail = '$emailId' AND role = 2";
	...
	if(isset($_POST['mobile_number']))
	{
		...
		$checkdata=" SELECT * FROM usertbl WHERE strMobileNum = '$mobileNum' AND role = 2";
